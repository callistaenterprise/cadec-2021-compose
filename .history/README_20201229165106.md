...
## Why is Jetpack Compose 
---
- ### Reduce Bugs!
- ### Write Clean code
- ### Great development experience

## Why is Jetpack Compose - Coupling and Cohesion 1/3
---
...
## Why is Jetpack Compose - Coupling and Cohesion 2/3
---
1. Coupling creates brittle highly implicit couplings.
2. XML View - Kotlin View, if you remove one or the other this can result in NullReferences
3. Hard to test as a unit


## Why is Jetpack Compose - Coupling and Cohesion 3/3
---
1. Cohesion 
